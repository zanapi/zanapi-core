...
var defaultGenerator = {
    name   : 'zanapi',
    time   : new Date(),
    url    : 'http://zanapijs.com',
    version: '0.0.0'
};

// TODO: find abetter name for PackageInfos (-> zanapi-conf)
...
function parse(options) {
    ...
    try {
        ...
        app.log.verbose('zanapi-generator name: '    + app.generator.name);
        app.log.verbose('zanapi-generator version: ' + app.generator.version);
        app.log.verbose('zanapi-core version: '      + packageJson.version);
        app.log.verbose('zanapi-spec version: '      + getSpecificationVersion());
        ...
        if (parsedFiles.length > 0) {
            ...
            // add zanapi specification version
            app.packageInfos.zanapi = SPECIFICATION_VERSION;
 ...
 * Set package infos.
 *
 * @param {Object} [packageInfos]             Collected from zanapi.json / package.json.
 ...
 * @param {String} [packageInfos.sampleUrl]   @see http://zanapijs.com/#param-api-sample-request
 */
 ...
 *
 * @param {String}   name           Name of the hook. Hook overview: https://github.com/zanapi/zanapi-core/hooks.md
